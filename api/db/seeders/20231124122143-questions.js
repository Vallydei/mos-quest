  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          title: 'Прогулка по музею сюрреализма!',
          question: 'Почему памятный знак в Музейном садике посвящен Святому Луке?',
        ...
        {
          title: 'Прогулка по музею сюрреализма!',
          question: 'На фасаде музея со стороны Музейного садика изображен персонаж древнегреческой мифологии, который является символом поэзии и вдохновения. Как его имя?',
          answer: 'Пегас',
          questId: 3,
          locationId: 6,
        },
        {
          title: 'Прогулка по музею сюрреализма!',
          question: 'Бурганов в своих произведениях использует символы – конь, крыло, птица и другие. Один из таких символов он изобразил в виде отдельной скульптуры, которая установлена в залах галереи «Пегас». Как она называется?',
          answer: 'Рука Творца',
          questId: 3,
          locationId: 6,
        },
        {
          title: 'Прогулка по музею сюрреализма!',
          question: 'В музее есть работа, представляющая сочетание обнаженного женского торса и конверта! А сколько таких работ создал Бурганов?',
          answer: '3',
          questId: 3,
          locationId: 6,
        },
